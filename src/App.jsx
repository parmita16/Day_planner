...
function App() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-100 via-rose-100 to-pink-200 flex justify-center items-center p-6">
      ...
      <div className="bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl w-full max-w-4xl p-8 border border-pink-200">
        ...
        <div className="text-center">
          ...
          <h1 className="text-5xl font-extrabold text-pink-600 mt-3">
            Plan A Day With Me╰(*°▽°*)╯
          </h1>
